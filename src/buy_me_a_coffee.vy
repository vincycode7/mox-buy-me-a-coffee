...
import src.get_price_module as gpm
...
def _fund():
    ...
    """
    usd_value_of_eth: uint256 = gpm._get_eth_to_usd_rate(PRICE_FEED, msg.value)
...
def get_eth_to_usd_rate(eth_amount: uint256) -> uint256:
    return gpm._get_eth_to_usd_rate(PRICE_FEED,eth_amount)
